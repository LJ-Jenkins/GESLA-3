classdef gesla_p
    methods(Static)
        ...
        function data = load_file(file,path,gflag_removal,cflag_removal,nw)
            ...
            %                      5 - missing value
            %    nw -> number of workers for the parallel for loop
            %
        ...
        function data = load_bbox(bounding_box,path,metadata,gflag_removal,cflag_removal,nw)
            ...
            data = gesla_p.load_file(filenames,path,gflag_removal,cflag_removal,nw);
        
        end

        function data = load_nearest(coords,n,path,metadata,gflag_removal,cflag_removal,nw)
        ...
        function data = load_country(country,path,metadata,gflag_removal,cflag_removal,nw)
